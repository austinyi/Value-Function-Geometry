...
def act(state):
    ...
    #eps_threshold = EPS_END + (EPS_START - EPS_END) * steps_done / (200*EPISODES)
    #print(eps_threshold)
    steps_done += 1
...
plt.ylabel('score')
plt.savefig('mc_dqn_noreward_score.png')
...
#ax.set_title('Value Function')       # title
...
ax.dist = 9   
#plt.show()                                             # distance from the plot
fig.savefig('mc_dqn_noreward.png')
